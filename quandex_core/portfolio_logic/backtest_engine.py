...
class BacktestEngine:
    ...
    def run_simulation(self) -> pl.DataFrame:
        ...
        for day_data in combined_data.iter_rows(named=True):
            ...
            if self.strategy_type == "PairsArbitrageStrategy":
                # Your existing, tested pairs trading logic would go here.
                # For brevity, this part is omitted, but it's the loop from the previous version.
                pass 
    ...
    # ... (generate_pyfolio_report and run_and_plot_in_notebook remain unchanged) ...
